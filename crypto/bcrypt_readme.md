...
```bash
go test -v --bench https://github.com/ArjavJP/Cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: https://github.com/ArjavJP/Cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	https://github.com/ArjavJP/Cosmos-sdk/crypto/keys/mintkey	12.093s
```

...
module](https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc) to your Cosmos SDK application and
...
by the port
[`Router`](https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc//core/05-port/types/router.go) on the
IBC module.
...
[`BeginBlock`](https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/core/02-client/abci.go) logic as
...
[`SimApp`](https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/simapp/app.go).

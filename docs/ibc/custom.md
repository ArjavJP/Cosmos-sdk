...
interface](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/core/05-port/types/module.go). This
...
simple version negotation is implemented in the [ibc-transfer module](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go).
...
[`OnRecvPacket`](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go).
:::
...
[channel types](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/core/04-channel/types).

While modules may choose arbitrary acknowledgement structs, a default acknowledgement types is provided by IBC [here](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/proto/ibc/core/channel/v1/channel.proto):
...
[Binding to transfer
port](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/genesis.go)

[Sending transfer
packets](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/keeper/relay.go)

[Implementing IBC
callbacks](https://https://github.com/ArjavJP/Cosmos-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go)
